...
const eventsData = [
    {
        ...
        date: "Every Sunday",
        description: "Join us for our weekly worship service filled with inspiring music, prayer, and biblical teaching.",
        image: "https://images.unsplash.com/photo-1438232992991-995b7058bbb3?w=400"
    },
    {
        title: "Youth Group Meeting",
        date: "November 15, 2025",
        description: "A fun and engaging gathering for young people to grow in faith and build community.",
        image: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=400"
    },
    {
        title: "Community Outreach",
        date: "November 22, 2025",
        description: "Join us as we serve our local community through various charitable activities.",
        image: "https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=400"
    },
    {
        title: "Christmas Carol Service",
        date: "December 24, 2025",
        description: "Celebrate the birth of Jesus with traditional carols and a special candlelight service.",
    ...
    },
    {
        ...
        description: "Come together for a powerful time of prayer and intercession.",
    ...
    col.innerHTML = `
        <div class="card event-card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-outline-primary btn-sm mt-2" onclick="showEventDetails('${event.title}')">
                    Learn More
                </button>
            </div>
        </div>
...
function showEventDetails(eventTitle) {
    alert(`More details about "${eventTitle}" will be available soon. Please contact the church office for more information.`);
}
